...
public class TicketManagerTest {
    ...
    private final Ticket ticket3 = new Ticket(3, 5700, "DME", "KUF", 60);
    private final Ticket ticket4 = new Ticket(4, 12000, "LED", "AER", 190);
    private final Ticket ticket5 = new Ticket(5, 8000, "DME", "ULV", 180);
    private final Ticket ticket6 = new Ticket(6, 5200, "KUF", "LED", 120);
